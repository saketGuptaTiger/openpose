...
BODY_25_FOLDER=${POSE_FOLDER}"body_25/"
wget -c https://drive.google.com/file/d/1jehFU9xsxEpxRuOEUgA5jaCutR4l9X8a/view?usp=drive_link -P ${BODY_25_FOLDER}


COCO_FOLDER=${POSE_FOLDER}"coco/"
wget -c https://drive.google.com/file/d/12k5CXCH4ZmCnXeBxPSkl0WNgJxj9oRVC/view?usp=drive_link -P ${COCO_FOLDER}


MPI_FOLDER=${POSE_FOLDER}"mpi/"
wget -c https://drive.google.com/file/d/16RbSDNfR-xNBgcjt3o2FeermGTPEQnWC/view?usp=drive_link -P ${MPI_FOLDER}

wget -c https://drive.google.com/file/d/1te1d4PwD1KjVDBW5eHmZ_08dcUoIOdAB/view?usp=drive_link -P ${FACE_FOLDER}

wget -c https://drive.google.com/file/d/1DsTdDmr2AOZlXvwSzoO4B8uRjBruy7WY/view?usp=drive_link -P ${HAND_FOLDER}
